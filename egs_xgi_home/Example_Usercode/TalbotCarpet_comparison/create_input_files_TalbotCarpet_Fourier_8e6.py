...
:start splitting algorithm definition:
	...
	:start optical element:
		...
		save at = ./TalbotCarpet_comparison/Fourier_8e6_$NG1/
...
N_G1=np.arange(5,43,2)
for j in N_G1:
	for i in range(index.size):
		egs_input_file_name = './Fourier_8e6_' + str(j) + '/TC_Fourier_8e6_NG1_' + str(j) + "_ind_" + str(i) + '.egsinp'
